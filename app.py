...
# Apply formatting parameters instantly from style module sheets
...
# ==========================================
# 4. ACTIVE DYNAMIC CURRICULUM DIRECTORY MAP (Safe Core Python Render)
# ==========================================
if st.session_state.show_topics_menu:
    st.markdown("<div class='curriculum-wave-panel'>", unsafe_allow_html=True)
    st.markdown("<h2 style='color:#ffffff; font-weight:800; margin-top:0; font-family:\'Plus Jakarta Sans\',sans-serif;'>📚 SemiPro Master Content Map</h2>", unsafe_allow_html=True)
    st.markdown("<p style='color:#9ca3af; font-size:0.95rem; margin-bottom:25px;'>Select any operational learning path module layout from the index grid clusters below:</p>", unsafe_allow_html=True)
    
    col_p1, col_p2, col_p3, col_p4, col_p5 = st.columns(5)
    with col_p1:
        st.markdown("<h4 style='color:#06b6d4; margin-bottom:5px; font-weight:700;'>Phase 1: CMOS</h4>", unsafe_allow_html=True)
        ...
        if st.button("Open Phase 1", key="jump_p1"):
            ...
            st.rerun()
    with col_p2:
        st.markdown("<h4 style='color:#06b6d4; margin-bottom:5px; font-weight:700;'>Phase 2: Digital</h4>", unsafe_allow_html=True)
        ...
        if st.button("Open Phase 2", key="jump_p2"):
            ...
            st.rerun()
    with col_p3:
        st.markdown("<h4 style='color:#06b6d4; margin-bottom:5px; font-weight:700;'>Phase 3: RTL</h4>", unsafe_allow_html=True)
        ...
        if st.button("Open Phase 3", key="jump_p3"):
            ...
            st.rerun()
    with col_p4:
        st.markdown("<h4 style='color:#06b6d4; margin-bottom:5px; font-weight:700;'>Phase 4: Synthesis</h4>", unsafe_allow_html=True)
        ...
        if st.button("Open Phase 4", key="jump_p4"):
            ...
            st.rerun()
    with col_p5:
        st.markdown("<h4 style='color:#06b6d4; margin-bottom:5px; font-weight:700;'>Phase 5: PD</h4>", unsafe_allow_html=True)
...
# ==========================================
# 5. HEADER HEADLINE TITLE PLATFORM IDENTIFIER
# ==========================================
st.markdown("<h1 style='font-weight:800; font-size:3rem; letter-spacing:-1.5px; color:#ffffff; margin-bottom:0px; margin-top:10px;'>SemiPro</h1>", unsafe_allow_html=True)

# ==========================================
# 6. MAIN CENTRAL CONTENT HUD VIEWPORT
# ==========================================
...
if st.session_state.current_page == "Home Dashboard":
    st.markdown("<p style='font-size:1.2rem; color:#9ca3af; font-weight:300; margin-bottom:45px; margin-top:0px;'>Master modern semiconductor integration tracks systematically from raw transistor logic up to sign-off tapeout.</p>", unsafe_allow_html=True)
