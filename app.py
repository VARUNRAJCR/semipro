...
# Apply styles from your independent style module sheets
apply_semiconductor_theme()

# ==========================================
# 2. INJECT ZERO-RELOAD "GIF POP" HARDWARE TAB LINK
# ==========================================
st.markdown("""
    <div class="gif-pop-container">
        <input type="checkbox" id="gifPopToggle">
        <label for="gifPopToggle" class="gif-pop-badge"></label>
        
        <div class="instant-curriculum-panel">
            ...
            <p style="color:#9ca3af; font-size:0.95rem; margin-bottom:25px; font-family:'Plus Jakarta Sans',sans-serif;">Select your target layout phase below:</p>
            ...
            <br>
            <p style="color:#64748b; font-size:0.85rem; margin-top:15px; border-top: 1px solid rgba(255,255,255,0.06); padding-top:15px;">💡 Note: To change active core workspaces, use your primary dashboard button controls down below.</p>
        </div>
    </div>
